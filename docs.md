...
Avoid explaining the code literally in your comments. For instance, don't write this:
...
Instead, clarify the code by using more meaningful variable names.
...
Python uses multi-line strings - docstrings - to document individual functions. Docstrings can be read by humans directly. They can be also be read by machines to create HTML documentation. There are three prevalent styles of docstrings:
